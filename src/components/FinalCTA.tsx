  ...
  return (
    <section className="noise relative overflow-hidden py-28 md:py-40">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 70% 100% at 50% 100%, rgb(232 130 59 / 0.35) 0%, rgb(244 190 146 / 0.22) 45%, transparent 75%)',
        }}
        aria-hidden
      />
      <motion.div
        className="pointer-events-none absolute bottom-[-6rem] left-1/2 h-64 w-64 -translate-x-1/2 rounded-full bg-flame/25 blur-3xl"
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-6 text-center">
        ...
        <Reveal delay={0.35}>
          <p className="mt-14 text-xs uppercase tracking-[0.3em] text-cocoa">
